...
// this is the first half of react grid code from MUI 
// we are storing the columns defined below in columns whose type is GridColDef
const columns: GridColDef[] = [
  { field: "id", headerName: "ID", width: 90 },
  {
    ...
    headerName: "Avatar",
    width: 100,
    //this is to render a profile icon  
    renderCell: (params) => {
